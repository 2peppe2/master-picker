...
CREATE TABLE "Requirement" (
    ...
    CONSTRAINT "Requirement_masterProgram_fkey" FOREIGN KEY ("masterProgram") REFERENCES "Master" ("master") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "_CourseToProgram" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,
    CONSTRAINT "_CourseToProgram_A_fkey" FOREIGN KEY ("A") REFERENCES "Course" ("code") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_CourseToProgram_B_fkey" FOREIGN KEY ("B") REFERENCES "Program" ("program") ON DELETE CASCADE ON UPDATE CASCADE
);

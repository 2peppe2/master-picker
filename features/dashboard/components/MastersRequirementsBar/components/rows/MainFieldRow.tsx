...
import { MainFieldRequirement } from "@/common/types";
...
const MainFieldRow: FC<MainFieldRowProps> = ({
  ...
  <div className="flex flex-col gap-2">
    <span className="leading-snug">
      ...
      <Translate text="_courses_in_one_of_the_following_fields" />:
    </span>
    <div className="flex flex-wrap gap-1.5">
      {requirement.fields.map((field) => (
        <div
          key={field}
          className={cn(
            "flex items-center gap-1.5 px-2 py-0.5 rounded-md border text-2xs font-medium transition-colors",

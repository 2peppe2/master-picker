...
/** Smallest a tile may get before the grid drops back to fewer columns. */
...
const CourseResultGridComponent: FC<CourseResultGridProps> = ({
  courses,
  draggedCourseCode,
}) => {
...
const CourseResultGrid = memo(CourseResultGridComponent);

const CourseResultsComponent: FC = () => {
...
const CourseResults = memo(CourseResultsComponent);

...
import GradeSummarySmall from "./GradeSummarySmall";
...
interface ExaminationCardSmallProps {
...
const ExaminationCardSmall: FC<ExaminationCardSmallProps> = ({
  exam,
  stats,
  isLoading,
...
export default ExaminationCardSmall;
